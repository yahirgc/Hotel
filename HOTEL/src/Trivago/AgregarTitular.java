...
public class AgregarTitular extends CitasSwingWorker {
    private Registro registro;

    public AgregarTitular(conexion objConexion, Registro registro, JTable tabla, DefaultTableModel modelo) {
